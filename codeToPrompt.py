...
# List of file paths including empty ones
file_paths = [
    r"langganan",
    ...
    r"templates",
    r"song",
    r"song\templates\song\song_detail.html",
    r"song\templates\song\song_list.html",
    r"song\templates\song\downloaded_songs.html",
    r"",
    r"",
    r"",
    r"",
